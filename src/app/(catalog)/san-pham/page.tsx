          ...
          <div className="mt-[20px] flex flex-wrap gap-2">
            {[
              ...
              <Link
                key={cat.href}
                href={cat.href}
                className={`px-[14px] py-[6px] text-[11px] font-semibold tracking-[2.22px] uppercase rounded-[5px] transition-colors duration-150 ${category === cat.value
              ...
              {products.map((product) => (
                ...
                >
                  ...
                  <div className="p-[20px]">
                    {product.category && (
                      <p className="text-[11px] font-semibold tracking-[2.22px] uppercase text-soft-gray mb-1">
                        {product.category}
                      </p>
                    )}
